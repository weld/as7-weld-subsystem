 ...
 */
public class LegacyStatefulSessionObjectReferenceImpl implements SessionObjectReference, Serializable {
    ...
    protected final StatefulSessionComponent ejbComponent;

    protected LegacyStatefulSessionObjectReferenceImpl(final SessionID id, final ServiceName createServiceName, final Map<String, ServiceName> viewServices) {
        this.id = id;
    ...
    protected LegacyStatefulSessionObjectReferenceImpl(EjbDescriptorImpl<?> descriptor) {
