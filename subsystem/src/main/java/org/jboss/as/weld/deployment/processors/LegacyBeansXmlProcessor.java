 ...
 *
 * This implementation does not use {@link PropertyReplacer} and is therefore compatible with AS 7.1.1.Final
 *
 * @author Stuart Douglas
 */
public class LegacyBeansXmlProcessor implements DeploymentUnitProcessor {
